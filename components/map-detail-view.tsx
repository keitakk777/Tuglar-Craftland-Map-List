...
import { Calendar, History, Star, Play, ArrowLeft, Trophy, Copy, Check, PlayCircle, ThumbsUp, Users, Gamepad2, User2 } from "lucide-react"
            ...
            <div className="grid grid-cols-2 gap-y-5 gap-x-4 mt-8">
               ...
               <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-0">
                    ...
                    <span className="text-yellow-600 font-bold text-[15px] leading-tight">{data.creator}</span>
                  </div>
               </div>
               ...
               <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-0">
                    ...
                    <span className="font-bold text-[15px] leading-tight uppercase">{data.mode}</span>
                  </div>
               </div>
               ...
               <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-0">
                    ...
                    <span className="font-bold text-[15px] leading-tight uppercase">{data.teamType}</span>
                  </div>
               </div>
               ...
               <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-0">
                    ...
                    <span className="font-bold text-[15px] leading-tight uppercase">{data.updateDate}</span>
                  </div>
               </div>
            </div>
              ...
              <motion.div className="space-y-0" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={containerVariants}> 
                {data.patchNotes?.map((note: any, index: number) => (
                  <motion.div key={index} className="relative pl-8 pb-12 last:pb-0" variants={itemVariants}>
                    {index !== data.patchNotes.length - 1 && <div className="absolute left-0 w-[2px] bg-yellow-500/10 top-[10px] bottom-0" />}
